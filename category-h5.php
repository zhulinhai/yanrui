...
?>
    <p class="position">您所在的位置：<a href="<?php echo home_url(); ?>">首页</a> - <a href="<?php echo home_url('case');?>">案例</a> - H5开发</p>
    <div class="page-4">
        <section class="section-1">
            <div id="categoryMenu" class="menu">
                <a href="<?php echo home_url('case'); ?>">全部</a>
                <a class="hover" href="<?php $cat=get_category_by_slug('h5'); echo get_category_link( $cat->term_id);  ?>">H5</a>
